...
```hcl
module "template-terraform-azure-resources-slave" {
  source = "github.com/BuunGroup-Templates/template-terraform-azure-resources-slave?ref=v1.0.0" // Replace with correct source and version
